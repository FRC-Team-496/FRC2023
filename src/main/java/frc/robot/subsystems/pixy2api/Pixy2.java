package frc.robot.subsystems.pixy2api;
...
public class Pixy2 extends SubsystemBase {
	...
	public Pixy2() {
        Pixy2.createInstance(LinkType.SPI);
    }
	 ...
	 * @return Pixy2 error code
	 */
	public byte setLamp(int upper, int lower) {
		int res;

		bufferPayload[0] = (byte) upper;
		bufferPayload[1] = (byte) lower;
		length = 2;
